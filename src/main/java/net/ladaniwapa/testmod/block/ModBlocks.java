package net.ladaniwapa.testmod.block;
...
public class ModBlocks {
    ...
    public static final Block RAW_RUBY_BLOCK = registerBlock("raw_ruby_block", new Block(FabricBlockSettings.copyOf(Blocks.EMERALD_BLOCK)));
